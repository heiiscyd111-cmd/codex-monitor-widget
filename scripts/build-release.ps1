...
$appFiles = @("main.js","preload.js","index.html","tooltip.html","package.json","icon.png","icon.ico","set-codex-owner.ps1","watch-foreground.ps1","USAGE.zh-CN.txt","README.md","LICENSE")
...
$sourceFiles = @("main.js","preload.js","index.html","tooltip.html","package.json","package-lock.json","icon.png","icon.ico","set-codex-owner.ps1","watch-foreground.ps1","USAGE.zh-CN.txt","README.md","LICENSE",".gitignore")
